...
const FAUNA_DB_DOMAIN = process.env.REACT_APP__FAUNA_DB_DOMAIN ||
  process.env.FAUNA_DB_DOMAIN || 'db.fauna.com'
...
class QueryManager {
  constructor(token) {
    ...
    this.bootstrapToken = token || process.env.REACT_APP__BOOTSTRAP_FAUNADB_KEY
